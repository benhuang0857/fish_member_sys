                ...
                <div class="col-lg-6">
                    <div class="card">
                        ...
                        <div class="card-footer">
                            <input type="button" id="start-game" class="btn btn-primary float-left" value="結束遊戲">
                            <input type="button" id="close-game" class="btn btn-primary float-right" value="開始遊戲">
                        </div>
                    </div>
                    <!-- /.card -->
                </div>
            ...
            <div class="col-lg-6">
                <div class="card">
                    ...
                    <form>
                        ...
                        <div class="card-footer">
                            <input type="button" class="btn btn-primary" value="綁定">
                        </div>
                    </form>
                </div>
                <!-- /.card -->
